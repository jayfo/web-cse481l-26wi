...
and examination of and reflection on designing with and for this emerging space.
...
- **Contact**
  ...
  Although we will aim to support the use of Ed Discussion for lightweight communication within the course,
...
- **Course Time & Location**
  ...
  [Bagley](https://www.washington.edu/maps/#!/BAG)
  Room [108](https://www.washington.edu/classroom/BAG+108).
...
- **Ed Discussion**
  ...
  <CourseDataLink linkKey={courseData.linkEdDiscussion} outerComponent="p"/>
...
- **GitLab**
  ...
  <CourseDataLink linkKey={courseData.linkGitLab} outerComponent="p"/>
...
- **10%: Participation.**
  ...
  discussing design, implementation, and principles of human-AI interaction.
...
In-person participation can also further impact grading of other course activities.
