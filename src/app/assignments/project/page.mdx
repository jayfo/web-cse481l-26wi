...
- To simplify the matching process, 
  we are assigning each group to do peer critique with the group before and after themselves in alphabetical order. 
  For example, Group B will conduct peer critiques with Group A and Group C.
